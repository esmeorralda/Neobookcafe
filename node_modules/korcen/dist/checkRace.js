...
var FALSE_POSITIVE_PATTERNS_RACE = ['흑형님'];
var allFalsePositivePatterns = __spreadArray([], FALSE_POSITIVE_PATTERNS_RACE, true);
...
var RACE_PROFANITY_PATTERNS = [
    '깜둥이', '흑형', '조센진', '짱개', '짱깨', '짱께', '짱게', '쪽바리', '쪽파리', '빨갱이', '니그로', '코쟁이', '칭총', '칭챙총', '섬숭이', '왜놈', '짱꼴라', '섬짱깨',
];
var allProfanityPatterns = __spreadArray([], RACE_PROFANITY_PATTERNS, true);
