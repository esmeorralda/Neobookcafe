...
function foreign(text) {
    ...
    var wtf = ["wtf"];
    for (var _i = 0, wtf_1 = wtf; _i < wtf_1.length; _i++) {
        var i = wtf_1[_i];
        if (text.includes(i)) {
            return true;
        }
    ...
    var foreign = ['2 girls 1 cup', '2g1c', '4r5e', '5h1t', '5hit', 'a$$hole', 'a_s_s', 'a55hole', 'acrotomophilia', 'ahole', 'alabama hot pocket',
    ...
    for (var _a = 0, foreign_1 = foreign; _a < foreign_1.length; _a++) {
        var i = foreign_1[_a];
        if (text.includes(i)) {
            return true;
        }
    }
    var foreign2 = ["肉便器", "糞野郎", "バカ野郎", "腐れ外道", "部落民", "中出し", "強姦", "特定アジア", "人非人", "鬼畜", "負け犬", "支那", "トルコ風呂", "淫売", "未開人"];
    for (var _b = 0, foreign2_1 = foreign2; _b < foreign2_1.length; _b++) {
        var i = foreign2_1[_b];
        if (text.includes(i)) {
            return true;
        }
    }
    var foreign3 = ['G巴', 'Ｇ巴', 'G叭', 'Ｇ叭', 'G芭', 'Ｇ芭', 'G掰', 'Ｇ掰', 'g點', 'MM屄', 'mm美圖',
    ...
    for (var _c = 0, foreign3_1 = foreign3; _c < foreign3_1.length; _c++) {
        var i = foreign3_1[_c];
        if (text.includes(i)) {
            return true;
        }
